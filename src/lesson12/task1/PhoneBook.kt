...
class PhoneBook {
    ...
    fun addPhone(name: String, phone: String): Boolean {
        if (name !in book.keys)
            ...
            for ((_, v) in book) if (phone in v) return false
            book[name]!!.add(phone)
            return true
        }
    }
    ...
    fun removePhone(name: String, phone: String): Boolean {
        if (name !in book.keys || phone !in book[name]!!) return false
     ...
     */
    override fun equals(other: Any?): Boolean = other is PhoneBook && other.book == this.book
